# Generated by Powerlevel10k configuration wizard on 2023-01-24 at 12:22 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION=$'%B%%%b%{\e[1 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[1 q%}'
  # Prompt symbol in command vi mode.
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION=$'%B%%%b%{\e[2 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[2 q%}'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_JAVA_VERSION_VISUAL_IDENTIFIER_EXPANSION=咖
