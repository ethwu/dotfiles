# Generated by Powerlevel10k configuration wizard on 2021-08-26 at 15:22 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # time                  # current time
    senary_time             # current time in misalian seximal units
    # newline                 # \n
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION=$'%B%%%b%{\e[5 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[5 q%}'
  # Prompt symbol in command vi mode.
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION=$'%B%%%b%{\e[1 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[1 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_FOREGROUND=2
  # Prompt symbol in visual vi mode.
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='V'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION=$'%B%%%b%{\e[1 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[1 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_FOREGROUND=5
  # Prompt symbol in overwrite vi mode.
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='▶'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION=$'%B%%%b%{\e[3 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIOWR_CONTENT_EXPANSION=$'%U%B%%%b%u%{\e[3 q%}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_FOREGROUND=6
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_VISUAL_IDENTIFIER_EXPANSION='∄'
  ...
  typeset -g POWERLEVEL9K_VCS_SUFFIX='%f]'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=1 #4
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=1 #4
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n%F{yellow}%b@%F{green}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n%F{yellow}@%F{green}%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%F{yellow}@%F{green}%m'
  ...
  # typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION=蟒
  # typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='蟒${P9K_CONTENT// }'
  ...
  typeset -g POWERLEVEL9K_ANACONDA_VISUAL_IDENTIFIER_EXPANSION='蟒'
  ...
  # typeset -g POWERLEVEL9K_RUST_VERSION_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_RUST_VERSION_VISUAL_IDENTIFIER_EXPANSION=鏽
  ...
  ###[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]####
  # Package color.
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_JENV_VISUAL_IDENTIFIER_EXPANSION=咖
  ...
  function prompt_senary_time() {
    p10k segment -f 8 -t `rn -ls`
  }
  ...
  function instant_prompt_senary_time() {
    prompt_senary_time
  }
  ...
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND=1
  function instant_prompt_history {
    p10k segment -t "$HISTCMD"
 }
